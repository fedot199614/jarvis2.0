...
public class Main extends ListenerAdapter {
  ...
  public static void main(String[] args) throws Exception {
    JDA jda = new JDABuilder(AccountType.BOT)
        .setToken("NDk4MTU0MTUxNTI0NDMzOTIz.DppmFA.sjQgIynq8yzR1pnS7NQMBYfoql4")
        .buildBlocking();
      ...
      if (Commands.play.equals(command[0]) && command.length == 2) {
        ...
        skipTrack(event.getTextChannel());
    	  ...
    	  if(connectedChannel!=null) {
    		  ...
    		  channel.sendMessage("� �� ��������� � Voice channel!").queue();
    	  }
    	  ...
    	  if(!trackList.isEmpty()) {
    		  ...
    		  channel.sendMessage("Play list ����!").queue();
    	  }
    	  ...
    	  System.out.println(user.getName()+" ������ ������ - "+ musicManager.player.getPlayingTrack().getInfo().title);
    	  channel.sendMessage(user.getName()+" ������ ������ - "+ musicManager.player.getPlayingTrack().getInfo().title).queue(); 	  
       }
    }
  ...
  private void loadAndPlay(TextChannel channel, final String trackUrl,Guild guild,VoiceChannel connectedChannel) {
    ...
    playerManager.loadItemOrdered(musicManager, trackUrl, new AudioLoadResultHandler() {
      ...
      public void playlistLoaded(AudioPlaylist playlist) {
        ...
        channel.sendMessage("�������� � ������� " + firstTrack.getInfo().title + " (������ ���� � ���� ����� " + playlist.getName() + ")").queue();
  ...
  private static void connectToFirstVoiceChannel(AudioManager audioManager,VoiceChannel voiceChannel,TextChannel textch) {
    if (!audioManager.isConnected() && !audioManager.isAttemptingToConnect()) {
    	...
    	if(voiceChannel == null) {
    		...
    		textch.sendMessage("���������� �������������� � voice channel!").queue();
    	}else {
